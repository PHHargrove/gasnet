...
#if GASNETC_HAVE_SEGMENT_PUBLISHM
  #define gex_Segment_PublishM gasnetc_Segment_PublishM
#else
  #define gex_Segment_PublishM gasneti_Segment_PublishM
#endif
extern int gex_Segment_PublishM(
            gex_TM_t       *_tm,
            size_t         _num_tm,
            gex_Flags_t    _flags);
